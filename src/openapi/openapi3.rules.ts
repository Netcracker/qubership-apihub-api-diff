...
export const openApi3Rules = (options: OpenApi3RulesOptions): CompareRules => {
  ...
  const externalDocumentationRules: CompareRules = {
    $: allAnnotation,
    classifyRuleId: REST_CLASSIFY_RULE_IDS.EXTERNAL_DOCS,
  ...
  const examplesRules: CompareRules = {
    ...
    '/*': {
      ...
      '/description': {
        $: allAnnotation,
        classifyRuleId: REST_CLASSIFY_RULE_IDS.EXAMPLES_DESCRIPTION,
      ...
      '/summary': {
        $: allAnnotation,
        classifyRuleId: REST_CLASSIFY_RULE_IDS.EXAMPLES_SUMMARY,
        description: diffDescription(resolveExamplesDescriptionTemplates()),
      },
      '/value': {
        $: allAnnotation,
        classifyRuleId: REST_CLASSIFY_RULE_IDS.EXAMPLES_VALUE,
        description: diffDescription(resolveExamplesDescriptionTemplates()),
        '/**': {
          $: allAnnotation,
          classifyRuleId: REST_CLASSIFY_RULE_IDS.EXAMPLES_VALUE_ITEM,
          description: diffDescription(resolveExamplesDescriptionTemplates()),
        }
      },
      ...openApiSpecificationExtensionRulesFunction(allAnnotation),
    },
    '/**': { $: allAnnotation, classifyRuleId: REST_CLASSIFY_RULE_IDS.EXAMPLES_DEEP },
  }
  ...
  const parametersRules: CompareRules = {
    '/*': {
      ...
      '/deprecated': {
        $: allDeprecated,
        classifyRuleId: REST_CLASSIFY_RULE_IDS.PARAMETER_DEPRECATED,
      ...
      '/example': {
        $: allAnnotation,
        classifyRuleId: REST_CLASSIFY_RULE_IDS.PARAMETER_EXAMPLE,
        description: diffDescription(resolveParameterDescriptionTemplates('example')),
        '/**': {
          $: allAnnotation,
          classifyRuleId: REST_CLASSIFY_RULE_IDS.PARAMETER_EXAMPLE_ITEM,
  ...
  const headersRules: CompareRules = {
    ...
    '/*': {
      ...
      '/description': {
        $: allAnnotation,
        classifyRuleId: REST_CLASSIFY_RULE_IDS.HEADER_DESCRIPTION,
        description: diffDescription(resolveHeaderDescriptionTemplates('description')),
      },
      '/example': {
        $: allUnclassified,
        classifyRuleId: REST_CLASSIFY_RULE_IDS.HEADER_EXAMPLE,
  ...
  const contentRules: CompareRules = {
    ...
    '/*': {
      ...
      '/example': {
        ...
        '/**': {
          $: allAnnotation,
          classifyRuleId: REST_CLASSIFY_RULE_IDS.MEDIA_TYPE_EXAMPLE_ITEM,
          description: diffDescription([
            `[{{${TEMPLATE_PARAM_ACTION}}}] {{${TEMPLATE_PARAM_PROPERTY_NAME}}} {{${TEMPLATE_PARAM_PREPOSITION}}} {{${TEMPLATE_PARAM_SCOPE}}} '{{${GREP_TEMPLATE_PARAM_RESPONSE_NAME}}}' ({{${GREP_TEMPLATE_PARAM_MEDIA_TYPE}}})`,
            `[{{${TEMPLATE_PARAM_ACTION}}}] {{${TEMPLATE_PARAM_PROPERTY_NAME}}} {{${TEMPLATE_PARAM_PREPOSITION}}} '{{${TEMPLATE_PARAM_COMPONENT_PATH}}}' ({{${GREP_TEMPLATE_PARAM_MEDIA_TYPE}}})`,
            `[{{${TEMPLATE_PARAM_ACTION}}}] {{${TEMPLATE_PARAM_PROPERTY_NAME}}} {{${TEMPLATE_PARAM_PREPOSITION}}} {{${TEMPLATE_PARAM_SCOPE}}} ({{${GREP_TEMPLATE_PARAM_MEDIA_TYPE}}})`,
  ...
  const requestBodiesRules: CompareRules = {
    ...
    '/description': {
      $: allAnnotation,
      classifyRuleId: REST_CLASSIFY_RULE_IDS.REQUEST_BODY_DESCRIPTION,
