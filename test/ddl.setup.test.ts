...
// T-SETUP smoke test: proves the ddlapi dependency and the ddlapi-enabled
// api-unifier build are wired up and that a Realm parsed from raw DDL is
// routed to the ddlapi spec type by resolveSpec.
describe('ddlapi dependency wiring (T-SETUP)', () => {
