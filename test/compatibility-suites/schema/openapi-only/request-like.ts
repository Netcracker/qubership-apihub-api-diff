...
export function runOpenApiOnlyRequestLikeSchemaTests(
  ...
  describe('OpenAPI-Only', () => {
    describe('OpenAPI Vocabulary', () => {
      // nullable tests use caseForSpecVersionPairs with REQUEST-LIKE expectations:
      // mark-schema-value-as-nullable: nullable option1 -> nonBreaking, option2 -> nonBreaking
      // mark-schema-value-as-non-nullable: option1 -> breaking, option2 -> breaking
